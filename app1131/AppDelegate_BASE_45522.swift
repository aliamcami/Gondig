...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        let vd = VideoDatabase(database: "SemNome.sqlite")
        let cami = VideoModelCamiTretas(name: "teste", level: VideoConfig.level.hard, time: VideoConfig.length.infinite)
        print(vd.addVideo(cami))
        print(vd.getAllVideos())
    ...
    func applicationDidBecomeActive(application: UIApplication) {
        ...
        copyIfNeeded("SemNome", type: "sqlite", toPath: NSHomeDirectory() + "/Library/Database")
    }
